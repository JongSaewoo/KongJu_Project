...
<body>
	...
	<div class="container">
		<form method="post" action="./menuWrite" enctype="multipart/form-data">
			...
			<table class="table table-bordered table-hover"
				...
				<thead>
					<tr>
						<th colspan="6"><h3>게시물 작성 양식</h3></th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						<td colspan="2"><h5>
								글 제목 <input type="hidden" name="userID"
									value="<%= user.getUserID() %>">
							</h5></td>
						<td colspan="4"><input class="form-control" type="text"
							maxlength="50" name="menuName" placeholder="메뉴이름"></td>
					</tr>

					<tr>
						<td colspan="2"><h5>레시피 내용</h5></td>
						<td colspan="4"><textarea class="form-control" rows="10"
								name="menuRecipe" maxlength="2048" placeholder="메뉴 내용"> </textarea></td>
					</tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text"
							id="comItem7 " maxlength="20" name="comItem7"
							placeholder="재료7 이름"></td>
						<td colspan="1"><input class="form-control" type="text"
	...
	<div class="modal fade" id="messageModal" tabindex="-1" role="dialog"
		...
		<div class="vertical-alignment-helper">
			<div class="modal-dialog vertical-align-center">
				<div
					class="modal-content <%if(messageType.equals("오류메세지")) out.println("panel-warning"); else out.println	("panel-success"); %>">
