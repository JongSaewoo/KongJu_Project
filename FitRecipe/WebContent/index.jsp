	...
	<nav class="navbar navbar-default">
		...
		<div class="container">
			...
			<div class="jumbotron">
				<div class="container">
					<h1>웹사이트 소개</h1>
					<p>자취생의 희망! 이 음식을 실제로 만들어보면 가격이 얼마나올까요?</p>
					<p>
...
<!--       <img class="img-responsive center-block" width="700px" src="images/김치찌개2.jpg" alt="김치찌개"> -->
<!--       <div class="carousel-caption"> -->
<!--      김치찌개 -->
<!--       </div> -->
<!--     </div> -->
<!--     <div class="item"> -->
<!--       <img class="img-responsive center-block" src="images/파스타.jpg" alt="파스타"> -->
<!--       <div class="carousel-caption"> -->
<!--         파스타 -->
<!--       </div> -->
<!--     </div> -->
<!--    <div class="item"> -->
<!--       <img class="img-responsive center-block" src="images/볶음밥.jpg" alt="볶음밥"> -->
<!--       <div class="carousel-caption"> -->
<!--         볶음밥 -->
<!--       </div> -->
<!--     </div> -->
