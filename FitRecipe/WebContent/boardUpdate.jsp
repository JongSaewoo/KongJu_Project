...
<html>
 <% 
   	...
   	if(!userID.equals(board.getUserID())){  //유저와 글쓴이가 다른 경우
   		session.setAttribute("messageType", "오류 메세지");
	...
	<div class="container">
		<form method="post" action="./boardUpdate" enctype="multipart/form-data">
			<table class="table table-bordered table-hover"
				...
				<thead>
					<tr>
						<th colspan="3"><h3>게시물 수정 양식</h3></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td>
						<input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="글제목을 입력하세요" value="<%=board.getBoardTitle() %>"> </td>
					</tr>
					
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5></td>
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글내용을 입력하세요" > <%=board.getBoardTitle() %></textarea></td>
					</tr>
					<tr>
