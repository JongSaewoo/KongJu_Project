...
<script type="text/javascript">
	function findFunction(){
		...
		$.ajax({
			...
			success: function(result){
				if(result ==-1){
					$('#checkMessage').html('친구이름:  친구찾기에 실패하셨습니다');
					...
					$('#checkMessage').html('친구이름:  친구찾기에 성공하셨습니다');
	...
	function getFriend(findID,userProfile ){
		$('#friendResult').html('<thead>' +
				...
				findID+'</h3><a href="chat.jsp?toID='+encodeURIComponent(findID)+'"class="btn btn-primary pull-right">'+ '메세지 보내기</a></td>'+
				'</tr>'+
				'</trbody>');
...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					<td style="width: 110px; "><h5>친구아이디</h5>
