		...
		<table class="table table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
			...
			<%
				for(int i =0 ; i< menuList.size(); i++){
					...
					comDAO.getComponent(menu.getMenuName());
			%>
				<tr>
					<td><img class="media-object img-circle" style="max-width:100px; max-height:60px; margin : 0 auto;" src="<%= menuDAO.getProfile(menu.getMenuNum()+"") %>"></td>
					<td><a href="menuShow.jsp?menuNum=<%=menu.getMenuNum() %>"><%= menu.getMenuNum() %></a></td>
					<td><a href="menuShow.jsp?menuNum=<%=menu.getMenuNum() %>"><%= menu.getMenuName() %></a></td>
					<td><%= menu.getMenuPrice() %>원</td>
			...
			%>
						...
						<td colspan="5"><a href="menuWrite.jsp" class="btn btn-primary pull-right" type="submit">글쓰기</a></td>		
